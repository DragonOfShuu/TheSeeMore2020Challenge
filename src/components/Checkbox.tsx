...
const Checkbox = (props: Props) => {
    ...
    return (
        <div className={className}>
            <label
                className={`size-full flex flex-row gap-3 select-none cursor-pointer`}
            >
                <div className={`grid size-5`}>
                    ...
                    />
                    <CheckIcon
                        className={`size-full object-contain col-start-1 row-start-1 dark:stroke-black hidden peer-checked:block`}
                    />
                </div>
                {text}
            </label>
