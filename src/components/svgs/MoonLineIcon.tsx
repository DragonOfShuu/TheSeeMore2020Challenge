...
const MoonLineIcon = (props: Props) => {
    return (
        <svg width="800px" height="800px" viewBox="0 0 24 24" className={props.className??`stroke-cblue-800`} fill="none" xmlns="http://www.w3.org/2000/svg">
