            ...
            {currDay ? (
                <>
                    <div className={`absolute max-xl:hidden`}>
                        <h2
                            className={`relative -top-9 -left-16 text-cblue-900/40 -z-10 text-6xl font-mono ${styles.blinkOn}`}
                        >
                            2020 CHALLENGE
                        </h2>
                    </div>
                    ...
                    >
                        <div
                            className={`flex flex-col justify-around lg:w-1/2 ${styles.topScreenToPosition}`}
                        >
                            <StreakCounter />
                            <ChallengeMark2020
                        ...
                        >
                            <MyDayBox
                                className={`${styles.bottomScreenToPosition}`}
                            />
                            <MyCallBox
                                className={`${styles.bottomScreenToPosition}`}
                            />
                ...
                >
                    <StreakCounter
                        className={`${styles.topScreenToPosition}`}
                    />
                    <Button
                        onClick={startDay}
                        className={`${styles.bottomScreenToPosition}`}
